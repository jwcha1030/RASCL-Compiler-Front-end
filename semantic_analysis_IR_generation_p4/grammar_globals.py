...
logicalexpr -> LPAREN condexpr logicalexprtail RPAREN #parenthesis were missing
logicalexprtail -> AND condexpr
logicalexprtail -> OR condexpr
logicalexprtail -> e
condexpr -> LPAREN logicalexpr RPAREN ##edited from 'LPAREN otherexpression condexprtail RPAREN'
condexpr -> otherexpression condexprtail
condexpr -> NOT condexpr
condexprtail -> relop condexpr
condexprtail -> e
...
logicalexpr_prod = {'logicalexpr':'LPAREN condexpr condexprtail logicalexprtail RPAREN'}
logicalexprtail_prod = {'and':'AND condexpr', 'or':'OR condexpr', 'e':'epsilon'}
condexpr_prod = {'parens':'LPAREN logicalexpr RPAREN', 'otherexpression':'otherexpression condexprtail', 'not':'NOT condexpr'}
condexprtail_prod = {'condexprtail':'relop condexpr', 'e':'epsilon'}
